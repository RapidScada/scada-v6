    ...
    public class DeviceTemplate
    {
        ...
        protected virtual void LoadFromXml(XmlNode rootNode)
        {
            ...
            if (elemGroupsNode != null)
            {
                ...
                {
                    DataBlock dataBlock = elemGroupElem.GetAttrAsEnum("dataBlock", 
                        elemGroupElem.GetAttrAsEnum<DataBlock>("tableType")); // "tableType" is old name
                    ElemGroup elemGroup = CreateElemGroup(dataBlock);
                    elemGroup.StartTagIdx = kpTagInd;
                    elemGroup.StartTagNum = kpTagInd + 1;
            ...
            if (cmdsNode != null)
            {
                ...
                foreach (XmlElement cmdElem in cmdNodes)
                {
                    ModbusCmd cmd = CreateModbusCmd(
                        cmdElem.GetAttrAsEnum("dataBlock", cmdElem.GetAttrAsEnum<DataBlock>("tableType")),
        ...
        public virtual void CopyFrom(DeviceTemplate srcTemplate)
        {
            ...
            {
                ElemGroup destGroup = CreateElemGroup(srcGroup.DataBlock);
            ...
            {
                ModbusCmd destCmd = CreateModbusCmd(srcCmd.DataBlock, srcCmd.Multiple);
