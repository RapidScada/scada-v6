...
namespace Scada.Comm.Drivers.DrvModbus.View.Forms
{
    ...
    public partial class FrmTemplateSettings : Form
    {
        ...
        /// </summary>
        private void SettingsToControls(DeviceTemplateOptions settings)
        {
        ...
        /// </summary>
        private void ControlsToSettings(DeviceTemplateOptions settings)
        {
        ...
        public static bool ShowDialog(DeviceTemplateOptions settings)
        {
            if (settings == null)
                throw new ArgumentNullException(nameof(settings));

            FrmTemplateSettings form = new();
        ...
        {
            // перевод формы
            FormTranslator.Translate(this, "Scada.Comm.Devices.Modbus.UI.FrmTemplateSettings");
        }
