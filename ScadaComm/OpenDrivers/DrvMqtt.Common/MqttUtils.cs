...
namespace Scada.Comm.Drivers.DrvMqtt
{
    ...
    public static class MqttUtils
    {
        ...
        /// <summary>
        /// Converts the payload contained in the message into an array of bytes.
        /// </summary>
        public static byte[] ConvertPayloadToArray(this MqttApplicationMessage applicationMessage)
        {
            return applicationMessage.PayloadSegment == null 
                ? null
