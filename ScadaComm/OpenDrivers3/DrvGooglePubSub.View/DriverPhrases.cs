...
namespace Scada.Comm.Drivers.DrvGooglePubSub.View
{
    ...
    {
        // Scada.Comm.Drivers.DrvGooglePubSub.View.GooglePubSubConfigProvider
        ...
        {
            LocaleDict dict = Locale.GetDictionary("Scada.Comm.Drivers.DrvGooglePubSub.View.GooglePubSubConfigProvider");
