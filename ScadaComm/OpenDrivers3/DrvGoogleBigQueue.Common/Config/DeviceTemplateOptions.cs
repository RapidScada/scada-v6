            ...
            switch (byteCnt)
            {
                case 2:
                    if (byteOrderArr2 == null)
                        byteOrderArr2 = BigQueueUtils.ParseByteOrder(DefByteOrder2);
                    return byteOrderArr2;

                case 4:
                    if (byteOrderArr4 == null)
                        byteOrderArr4 = BigQueueUtils.ParseByteOrder(DefByteOrder4);
                    return byteOrderArr4;

                case 8:
                    if (byteOrderArr8 == null)
                        byteOrderArr8 = BigQueueUtils.ParseByteOrder(DefByteOrder8);
