...
namespace Scada.Comm.Drivers.DrvGooglePubSub.Logic
{
    ...
    /// </summary>
    public class DrvGooglePubSubLogic : DriverLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvGooglePubSubLogic(ICommContext commContext)
            : base(commContext)
        {
        }
        ...
        {
            return new DevGooglePubSubLogic(CommContext, lineContext, deviceConfig);
        }
    }
}
