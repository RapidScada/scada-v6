...
namespace Scada.Comm.Drivers.DrvSmsParser.Logic
{
    ...
    /// </summary>
    public class DrvSmsParserLogic : DriverLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvSmsParserLogic(ICommContext commContext)
            : base(commContext)
        {
        }
        ...
        {
            return new DevSmsParserLogic(CommContext, lineContext, deviceConfig);
        }
    }
}
