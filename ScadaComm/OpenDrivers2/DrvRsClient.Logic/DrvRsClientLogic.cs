...
namespace Scada.Comm.Drivers.DrvRsClient.Logic
{
    ...
    /// </summary>
    public class DrvRsClientLogic : DriverLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvRsClientLogic(ICommContext commContext)
            : base(commContext)
        {
        }
        ...
        {
            return new DevRsClientLogic(CommContext, lineContext, deviceConfig);
        }
    }
}
