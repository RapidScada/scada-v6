...
{
	public partial class CtrlInputImportCnl : UserControl, INotifyPropertyChanged
	{
		...
		private void rdbEnableImport_CheckedChanged(object sender, EventArgs e)
		{
			// Enable/Disable and Show/Hide txtPathFile and btnImport based on RadioButton's Checked state
		...
		private void radioButton1_CheckedChanged(object sender, EventArgs e)
		{
			...
			btnImport.Enabled = radioButton1.Checked;
			btnImport.Visible = radioButton1.Checked;
		}
	}
