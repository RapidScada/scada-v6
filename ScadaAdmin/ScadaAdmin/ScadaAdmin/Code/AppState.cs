 ...
 * Summary  : Represents a state of application controls
 * 
...
{
    /// <summary>
    /// Represents a state of application controls.
    /// <para>Представляет состояние элементов управления в приложении.</para>
    /// </summary>
    public class AppState
    {
        ...
        /// </summary>
        public const string DefaultFileName = "ScadaAdminState.xml";
        /// <summary>
