 ...
 * Summary  : Represents a state of the main form controls
 * 
...
{
    /// <summary>
    /// Represents a state of the main form controls.
    /// <para>Представляет состояние элементов управления главной формы.</para>
    /// </summary>
