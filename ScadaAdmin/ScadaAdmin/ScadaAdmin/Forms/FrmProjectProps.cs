 ...
 * Summary  : Represents a form for editing project properties
 * 
...
{
    /// <summary>
    /// Represents a form for editing project properties.
    /// <para>Представляет форму для редактирования свойств проекта.</para>
    /// </summary>
