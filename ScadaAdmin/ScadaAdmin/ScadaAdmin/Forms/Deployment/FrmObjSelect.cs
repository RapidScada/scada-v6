 ...
 * Summary  : Represents a form for selecting objects
 * 
...
{
    /// <summary>
    /// Represents a form for selecting objects.
    /// <para>Представляет форму для выбора объектов.</para>
    /// </summary>
    public partial class FrmObjSelect : Form
    {
        ...
        private void ShowObjects()
        {
            ...
            List<DataGridViewColumn> columns = ColumnBuilder.CreateColumns(configBase, typeof(Obj)).ToList();
