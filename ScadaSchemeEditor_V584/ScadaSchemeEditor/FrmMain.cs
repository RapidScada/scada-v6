...
namespace Scada.Scheme.Editor
{
    ...
    public partial class FrmMain : Form, IMainForm
    {
        ...
        /* 对齐 
         图标：https://www.iconfont.cn/collections/detail?spm=a313x.search_index.0.da5a778a4.2f7e3a81FJZjXF&cid=11607
         */
        private void btnAlignLeft_Click(object sender, EventArgs e)
        {
            editor.CompAlign(CompAlignEnum.Left);
        }

        private void btnAlignRight_Click(object sender, EventArgs e)
        {
            editor.CompAlign(CompAlignEnum.Right);
        }

        private void btnAlignTop_Click(object sender, EventArgs e)
        {
            editor.CompAlign(CompAlignEnum.Top);
        }

        private void btnAlignBottom_Click(object sender, EventArgs e)
        {
            editor.CompAlign(CompAlignEnum.Bottom);
        }

        private void btnAlignVerticle_Click(object sender, EventArgs e)
        {
            editor.CompAlign(CompAlignEnum.Verticle);
        }

        private void btnAlignCenter_Click(object sender, EventArgs e)
        {
            editor.CompAlign(CompAlignEnum.Center);
        }

        private void btnAlignPicSide_Click(object sender, EventArgs e)
        {
            editor.CompAlignPic(CompAlignEnum.PicSide);
        }

        private void btnAlignPicCenter_Click(object sender, EventArgs e)
        {
            editor.CompAlignPic(CompAlignEnum.PicCenter);
        }
    }
}
