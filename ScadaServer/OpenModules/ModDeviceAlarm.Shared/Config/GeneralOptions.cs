...
namespace Scada.Server.Modules.ModDeviceAlarm.Config
{
    ...
    internal class GeneralOptions
    {
        ...
        /// 邮件发送次数
        /// </summary>
        public int SendTimes { get; internal set; }
        ...
        public void LoadFromXml(XmlNode xmlNode)
        {
            ...
            SendTimes = xmlNode.GetChildAsInt("SendTimes", SendTimes);
            EmailAddress = xmlNode.GetChildAsString("EmailAddress","");
            EmailSubject = xmlNode.GetChildAsString("EmailSubject","");
            EmailContent = xmlNode.GetChildAsString("EmailContent","");
        }
        ...
        public void SaveToXml(XmlElement xmlElem)
        {
            ...
            xmlElem.AppendElem("SendTimes", SendTimes);
            xmlElem.AppendElem("EmailAddress", EmailAddress);
            xmlElem.AppendElem("EmailSubject", EmailSubject);
            xmlElem.AppendElem("EmailContent", EmailContent);
        }
    }
}
