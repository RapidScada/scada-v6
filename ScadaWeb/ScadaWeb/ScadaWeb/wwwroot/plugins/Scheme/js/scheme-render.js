...
scada.scheme.StaticPolygonRenderer.prototype = Object.create(
    scada.scheme.ComponentRenderer.prototype,
);
scada.scheme.StaticPolygonRenderer.constructor =
    scada.scheme.StaticPolygonRenderer;

scada.scheme.StaticPolygonRenderer.prototype.generatePolygonPath = function (
    numPoints,
) {
...
scada.scheme.StaticPolygonRenderer.prototype.createDom = function (
    component,
    renderContext,
) {
    var props = component.props;
...
scada.scheme.DynamicPolygonRenderer.prototype = Object.create(
    scada.scheme.StaticPolygonRenderer.prototype,
);
scada.scheme.DynamicPolygonRenderer.constructor =
    scada.scheme.DynamicPolygonRenderer;

scada.scheme.DynamicPolygonRenderer.prototype.createDom = function (
    component,
    renderContext,
) {
    scada.scheme.StaticPolygonRenderer.prototype.createDom.call(
        this,
        component,
        renderContext,
    );
...
scada.scheme.DynamicPolygonRenderer.prototype.updateData = function (
    component,
    renderContext,
) {
    var props = component.props;
...
scada.scheme.rendererMap = new Map([
    ...
    ["Scada.Web.Plugins.PlgScheme.Model.StaticPolygon", new scada.scheme.StaticPolygonRenderer(),],
    ["Scada.Web.Plugins.PlgScheme.Model.DynamicPolygon", new scada.scheme.DynamicPolygonRenderer(),],
