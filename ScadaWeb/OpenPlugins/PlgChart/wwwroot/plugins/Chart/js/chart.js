...
// Contains a chart control, related objects and classes.
// Depends on jquery
...
// Represents a chart.
scada.chart.Chart = function (chartElemID) {
    ...
    // Indicates that iOS is in use, which affects some JavaScript functions.
    this.iOS = false;
    // The time range.
...
scada.chart.Chart.prototype._timeToStr = function (t, showSeconds) {
    ...
    return this.iOS ? // iOS requires manual time formatting
